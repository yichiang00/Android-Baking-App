...
public class MainActivity extends AppCompatActivity implements MasterListFragment.OnImageClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        URL url = NetworkUtils.buildUrl(NetworkUtils.RECEIPT_URL);
        RecyclerView gridView = (RecyclerView) findViewById(R.id.images_grid_view);
        MasterListAdapter adapter = (MasterListAdapter) gridView.getAdapter();

        AsyncTask receiptTask= new ReceiptQueryTask(this, adapter);
//        {
//            @Override
...
//                    MasterListAdapter adapter = (MasterListAdapter) gridView.getAdapter();
//
//                    adapter.setReceiptItems(result);
//                }
//            }
//        }
       //
         receiptTask.execute("Hi");
